...
mkdir ../data/raw/new_genomes/trim/next
mv ../data/raw/new_genomes/trim/*fq.gz  ../data/raw/new_genomes/trim/next 

# Mapping samples against the genome reference 
for R in `ls ../data/raw/new_genomes/trim/next | grep -oE "\w*_" | uniq`;
do bwa mem -t 10 -M ../data/raw/reference/TM-1_V2.1.fa ../data/raw/new_genomes/trim/next/${R}1.fq.gz ../data/raw/new_genomes/trim/next/${R}2.fq.gz > ../data/raw/new_genomes/trim/next/${R}.sam ;
done
