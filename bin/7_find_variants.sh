...
do java -jar -Xms16000M -Xmx16000M ../NGSEPcore_3.3.0.jar FindVariants -runRep -runRD -runRP -maxAlnsPerStartPos 100 -csb -ploidy 4 -psp -algCNV CNVnator,EWT ../data/raw/reference/TM-1_V2.1.fa ../data/raw/resequenced/trim/next/${R}sortedRG.bam ../data/raw/resequenced/trim/next/${R}1 >& ../data/raw/resequenced/trim/next/${R}.log;
done

## Merge variants
for R in `ls ../data/raw/resequenced/trim/next | grep -oE "\w*_" | uniq`;
do java -jar -Xms16000M -Xmx16000M ../NGSEPcore_3.3.0.jar MergeVariants  ../data/raw/reference/TM-1_V2.1.fa.fai  ../data/raw/resequenced/trim/next/${R}2  ../data/raw/resequenced/trim/next/${R}1.vcf  >& ../data/raw/resequenced/trim/next/${R}merg.log; 
done

### Find variants
for R in `ls ../data/raw/resequenced/trim/next | grep -oE "\w*_" | uniq`;
do java -jar -Xms16000M -Xmx16000M ../NGSEPcore_3.3.0.jar FindVariants -csb -ploidy 4 -psp -knownVariants ../data/raw/resequenced/trim/next/${R}2 -knownSVs ../data/raw/resequenced/trim/next/${R}1SV.gff  -maxBaseQS 30 -maxAlnsPerStartPos 100 -sampleId ${R} ../data/raw/reference/TM-1_V2.1.fa ../data/raw/resequenced/trim/next/${R}sortedRG.bam ../data/raw/resequenced/trim/next/${R}3 >& ../data/raw/resequenced/trim/next/${R}var3.log;
done
